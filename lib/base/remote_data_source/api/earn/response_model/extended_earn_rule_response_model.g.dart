...
part of 'extended_earn_rule_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ExtendedEarnRule _$ExtendedEarnRuleFromJson(Map<String, dynamic> json) {
  return ExtendedEarnRule(
    ...
    customerCompletionCount: json['CustomerCompletionCount'] as int,
    ...
    conditions: (json['Conditions'] as List)
            ?.map((e) => e == null
                ? null
                : ExtendedEarnRuleCondition.fromJson(e as Map<String, dynamic>))
            ?.toList() ??
        [],
...
Map<String, dynamic> _$ExtendedEarnRuleToJson(ExtendedEarnRule instance) =>
    <String, dynamic>{
      'Id': instance.id,
      ...
      'CustomerCompletionCount': instance.customerCompletionCount,
