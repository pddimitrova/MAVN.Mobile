...
class PendingVoucherBloc extends GenericDetailsBloc<VoucherResponseModel> {
  PendingVoucherBloc(this._voucherRepository);

  final VoucherRepository _voucherRepository;

  @override
  Future<VoucherResponseModel> loadData(String identifier) =>
      _voucherRepository.getPendingVoucher();
}

PendingVoucherBloc usePendingVoucherBloc() =>
    ModuleProvider.of<HomePageModule>(useContext()).pendingVoucherBloc;
