...
class CampaignOfDayBloc extends GenericDetailsBloc<CampaignResponseModel> {
  CampaignOfDayBloc(this._campaignRepository);

  final CampaignRepository _campaignRepository;

  @override
  Future<CampaignResponseModel> loadData(String identifier) =>
      _campaignRepository.getCampaignOfDay();
}

CampaignOfDayBloc useCampaignOfDayBloc() =>
    ModuleProvider.of<HomePageModule>(useContext()).campaignOfDayBloc;
